...
| `contenteditable` | Partial | GitHub, Notion, rich text editors &mdash; may misbehave or have strange behavior depending on the site's implementation. Use the scratch buffer (`:e`) as a workaround |
